...
class Home_page(Frame):
    ...
    def create_widgets(self):
        ...
        Label(self, text="Phoenix", font="Courier 40 bold", bg="coral",
        ...
        Label(self,
              text="Word Search", font="Courier 30 bold", bg="coral",
              fg="gold").grid(row=1, column=1, sticky=N)

        Label(self,
              text="Can you solve them all?", font="Courier 20 italic", bg="coral",
              fg="red").grid(row=2, column=1, sticky=N)

        Label(self, text="", bg="coral",
              ).grid(row=3, column=2, sticky=N)

        Button(self, text="Instructions", bg="light gray", fg="orange2",
        ...
        Button(self, text="Word Search", bg="light gray", fg="orange2",
